    ...
    <div class="row">
        <div class="col-xs-5">
            <div class="form-group ">
                ...
                <div class="col-xs-9 ">
                    <input type="text" required value="${user.userNumber }" name="userNumber" class="form-control"
                           placeholder="请输入用户学号"/>
                </div>
            </div>
        </div>
    ...
    <div class="row">
        <div class="col-xs-5">
            <div class="form-group ">
                ...
                <div class="col-xs-9 ">
                    <input type="text" required value="${user.userAge }" name="userAge" class="form-control"
                           placeholder="请输入用户年龄"/>
                </div>
            </div>
        </div>
    ...
    <div class="row">
        <div class="col-xs-5">
            <div class="form-group ">
                ...
                <div class="col-xs-9">
                    <input type="text" required value="${user.userAccount }" name="userAccount" class="form-control"
                           placeholder="请输入用户账号"/>
                </div>
            </div>
        </div>
        <div class="col-xs-5">
            <div class="form-group ">
                ...
                <div class="col-xs-9 ">
                    <input type="password" value="${user.userPw }" name="userPw" class="form-control"
                           placeholder="密码为空则默认不修改"/>
                </div>
            </div>
        </div>
    </div>
