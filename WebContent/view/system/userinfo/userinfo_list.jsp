    ...
    <div class="row alert alert-info" style="margin: 0px; padding: 5px;">
        <div class="form-group">
            ...
            <select name="condition" class="form-control">
                <option value="userName" ${condition eq "userName"? "selected=‘selected’" : "" } >姓名</option>
                <option value="userAccount" ${condition eq "userAccount"? "selected=’selected‘" : "" } >账号</option>
            </select>
            <input type="text" name="content" value="${content }" class="form-control" placeholder="请输入查询条件"/>
        </div>
