...
<div class="navbar navbar-default" id="navbar">
		...
		<div class="navbar-container" id="navbar-container">
			<div class="navbar-header pull-left">
				<a href="view/system/main/index.jsp" class="navbar-brand">
					<small>
						<i class="icon-leaf"></i> 别先生-图书管理系统
					</small>
				</a>
				<!-- /.brand -->
			</div>
					...
					<li class="light-blue">
						<a data-toggle="dropdown" href="#" class="dropdown-toggle">
							...
							<span class="user-info">
								<small>欢迎光临,${userLogin.userAccount }</small>
							</span>
						...
						<ul class="user-menu pull-right dropdown-menu dropdown-yellow dropdown-caret dropdown-close">
							<li>
								<a href="view/system/userinfo/userinfo_show.jsp" target="mainframe">
							...
							<li>
								<a href="system/user/logout"> <i class="icon-off"></i> 退出</a>
							</li>
						</ul>
					</li>
		...
		<div class="main-container-inner">
			...
			<div class="sidebar" id="sidebar">
				...
				<ul class="nav nav-list">
					...
					<li class="active">
						<a href="view/system/main/main.jsp" target="mainframe">
					...
					<li>
						...
						<ul class="submenu">
							<li>
								<a href="system/user/select" target="mainframe">
					...
					<li>
						...
						<ul class="submenu">
                            <li>
								<a href="system/book/select" target="mainframe">
									<i class="icon-double-angle-right"></i> 图书管理
								</a>
							</li>
							<li>
								<a href="system/bookSort/select" target="mainframe">
									<i class="icon-double-angle-right"></i> 图书类别
								</a>
							</li>
                      	     <!--
                      	     <li>
                      	     	<a href="view/crm/customer/customer_list.html" target="mainframe">
                      	     		<i class="icon-double-angle-right"></i> 图书记录管理
								</a>
							 </li>
							-->
			...
			<div class="main-content" id="mains">
				<iframe id="mainframe" name="mainframe" src="view/system/main/main.jsp" style="width: 100%;border: 0px;"> </iframe>
			</div>
